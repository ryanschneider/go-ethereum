...
func TestValidateBuilderSubmissionV1(t *testing.T) {
	...
	ethservice.TxPool().Add([]*types.Transaction{tx1}, true, true)
	...
	ethservice.TxPool().Add([]*types.Transaction{cc}, true, true)
	...
	ethservice.TxPool().Add([]*types.Transaction{tx2}, true, true)
